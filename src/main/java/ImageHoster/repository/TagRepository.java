...
public class TagRepository {
    ...
    //Executes JPQL query to fetch the tags from the database
    //Returns the tags in case the tag is found in the database
    //Returns null if no tag is found in the database
